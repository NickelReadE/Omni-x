...
export const CHAIN_COLORS = {
  [CHAIN_IDS[CHAIN_TYPE.GOERLI]]: 'bg-[#8C8C8C]',
  [CHAIN_IDS[CHAIN_TYPE.BSC_TESTNET]]: 'bg-[#F0B90B]',
  [CHAIN_IDS[CHAIN_TYPE.MUMBAI]]: 'bg-[#8247E5]',
  [CHAIN_IDS[CHAIN_TYPE.FUJI_TESTNET]]: 'bg-[#E84142]',
  [CHAIN_IDS[CHAIN_TYPE.OPT_TESTNET]]: 'bg-[#FF0420]',
  [CHAIN_IDS[CHAIN_TYPE.ARB_TESTNET]]: 'bg-[#28A0F0]',
  [CHAIN_IDS[CHAIN_TYPE.FANTOM_TESTNET]]: 'bg-[#13B5EC]',

  [CHAIN_IDS[CHAIN_TYPE.ETHEREUM]]: 'bg-[#8C8C8C]',
  [CHAIN_IDS[CHAIN_TYPE.BINANCE]]: 'bg-[#F0B90B]',
  [CHAIN_IDS[CHAIN_TYPE.POLYGON]]: 'bg-[#8247E5]',
  [CHAIN_IDS[CHAIN_TYPE.AVALANCHE]]: 'bg-[#E84142]',
  [CHAIN_IDS[CHAIN_TYPE.ARBITRUM]]: 'bg-[#FF0420]',
  [CHAIN_IDS[CHAIN_TYPE.OPTIMISM]]: 'bg-[#28A0F0]',
  [CHAIN_IDS[CHAIN_TYPE.FANTOM]]: 'bg-[#13B5EC]',
}
