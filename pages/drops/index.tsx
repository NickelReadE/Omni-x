    ...
    <div className='w-full'>
      <div className='flex w-full justify-center'>
        <div className={"flex flex-col items-center py-8"}>
          ...
          <TextSH2 className={"text-secondary text-shadow-sm"}>the best place to launch your next NFT collection</TextSH2>
          <div className={"flex items-center space-x-4 mt-4"}>
            ...
            >
              <div
                className={
                  "flex items-center justify-center bg-primary-gradient rounded-full py-2 px-4 hover:shadow-[0_0_6px_rgba(0,240,236,1)]"
                }
              >
      ...
      {loading ? (
        ...
        <>
          <div className='flex flex-col mt-8'>
            <TextH2 className='text-primary-light'>Live Drops</TextH2>
            <TextSH2 className={"text-secondary"}>minting is live on these awesome projects!</TextSH2>
          </div>
          ...
          {collectionsForComing.length > 0 && (
            <div className='mt-12'>
              <TextH2 className='text-primary-light'>Upcoming Drops</TextH2>
              <TextSH2 className={"text-secondary"}>explore Omni X vetted projects with incredible promise</TextSH2>
