...
import { GradientSpan } from '../basic'
  ...
  return (
    <div className="py-[230px]">
      <div className="flex justify-center w-full space-x-2">
        ...
        <span className="text-[40px] leading-[48px] font-semibold italic bg-clip-text text-center text-transparent bg-primary-gradient shadow-[0_4_6px_rgba(0,0,0,0.25)]">omnichain</span>
      ...
      <div className="flex w-full mt-12 space-x-4">
        <div className="flex flex-1 justify-center items-center flex-col">
          <span className='text-secondary text-xl text-center'>
                      A multichain world needs <GradientSpan>real omnichain solutions.</GradientSpan> Your NFTs on 10+ blockchains (and counting) can all be viewed, traded, and shared all in one place - Omni X.
          </span>
        ...
        <div className="flex flex-1 flex-col space-y-8 pl-8">
          <IntroCard title="NFT interpoerability">
            <div className='flex flex-col items-center'>
              <span className='text-xl text-secondary text-center'>
                <GradientSpan className='mr-1'>bridge</GradientSpan>
                any pre-existing NFT to any chain using our wrapped asset bridge, or
                <GradientSpan>mint omnichain NFTs&nbsp;</GradientSpan>
          ...
          <IntroCard title="deep & frictionless liquidity">
            <div className='flex flex-col items-center space-y-4'>
              <span className='text-xl text-secondary text-center mt-5'>
                trade any asset, on any chain, with any token*
              </span>
              <span className='text-xl text-secondary text-center'>
                a new paradigm that <GradientSpan>exponentially increases available liquidity</GradientSpan> for artists and traders
              </span>
