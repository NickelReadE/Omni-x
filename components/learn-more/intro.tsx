...
const IconBox = ({ children }: IPropsIconBox) => {
  return (
    <div className='h-[56px] w-[56px] rounded-md flex items-center justify-center bg-border-gradient border-[1px] border-solid border-transparent' style={{backgroundOrigin: 'padding-box, border-box', backgroundClip: 'padding-box, border-box'}}>
      {children}
    </div>
  )
}
  ...
  return (
    <div>
      ...
      <div className='flex justify-between space-x-12 pt-[150px]'>
        <IntroCard title="ONFTs" className={'flex flex-1 justify-center h-[214px] hover:shadow-[0_0_30px_#FFE817]'}>
          <Image src={OmniChainImage} alt="omnichain" />
        </IntroCard>
        <IntroCard title="web3 social" className={'flex flex-1 justify-center h-[214px] hover:shadow-[0_0_30px_#FFE817]'}>
          <div className='flex w-full justify-around'>
            <IconBox>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20.8401 4.60987C20.3294 4.09888 19.7229 3.69352 19.0555 3.41696C18.388 3.14039 17.6726 2.99805 16.9501 2.99805C16.2276 2.99805 15.5122 3.14039 14.8448 3.41696C14.1773 3.69352 13.5709 4.09888 13.0601 4.60987L12.0001 5.66987L10.9401 4.60987C9.90843 3.57818 8.50915 2.99858 7.05012 2.99858C5.59109 2.99858 4.19181 3.57818 3.16012 4.60987C2.12843 5.64156 1.54883 7.04084 1.54883 8.49987C1.54883 9.95891 2.12843 11.3582 3.16012 12.3899L4.22012 13.4499L12.0001 21.2299L19.7801 13.4499L20.8401 12.3899C21.3511 11.8791 21.7565 11.2727 22.033 10.6052C22.3096 9.93777 22.4519 9.22236 22.4519 8.49987C22.4519 7.77738 22.3096 7.06198 22.033 6.39452C21.7565 5.72706 21.3511 5.12063 20.8401 4.60987Z" fill="url(#paint0_linear_185_420)" stroke="url(#paint1_linear_185_420)" strokeLinecap="round" strokeLinejoin="round"/>
                <defs>
                  <linearGradient id="paint0_linear_185_420" x1="5.46816" y1="2.99805" x2="23.0191" y2="7.85782" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#FA16FF"/>
                    <stop offset="1" stopColor="#F00056"/>
                  </linearGradient>
                  <linearGradient id="paint1_linear_185_420" x1="5.46816" y1="2.99805" x2="23.0191" y2="7.85782" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#FA16FF"/>
                    <stop offset="1" stopColor="#F00056"/>
                  </linearGradient>
                </defs>
            ...
            <IconBox>
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M22 10.3889C22.0042 12.0021 21.6273 13.5934 20.9 15.0333C20.0376 16.7588 18.7119 18.2101 17.0713 19.2247C15.4307 20.2393 13.5401 20.777 11.6111 20.7778C9.99792 20.782 8.40657 20.4051 6.96666 19.6778L0 22L2.32222 15.0333C1.59491 13.5934 1.21801 12.0021 1.22222 10.3889C1.22297 8.45995 1.76074 6.56929 2.77532 4.9287C3.78989 3.28811 5.24119 1.96239 6.96666 1.10003C8.40657 0.372728 9.99792 -0.00417115 11.6111 3.48187e-05H12.2222C14.7697 0.14058 17.1759 1.21585 18.98 3.01997C20.7841 4.82409 21.8594 7.23027 22 9.7778V10.3889Z" fill="url(#paint0_linear_185_424)"/>
                <defs>
                  <linearGradient id="paint0_linear_185_424" x1="4.125" y1="-8.54139e-07" x2="22.9171" y2="4.53847" gradientUnits="userSpaceOnUse">
            ...
            <IconBox>
              <svg width="22" height="27" viewBox="0 0 22 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M1 12.5757V10.3939C1 9.2366 1.45974 8.12669 2.27808 7.30835C3.09642 6.49001 4.20633 6.03027 5.36363 6.03027H20.6364" stroke="url(#paint1_linear_185_428)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M5.36363 25.6667L1 21.3031L5.36363 16.9395" stroke="url(#paint2_linear_185_428)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M20.6364 14.7573V16.9391C20.6364 18.0964 20.1766 19.2064 19.3583 20.0247C18.5399 20.843 17.43 21.3028 16.2727 21.3028H1" stroke="url(#paint3_linear_185_428)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <defs>
                  <linearGradient id="paint0_linear_185_428" x1="17.0909" y1="1.6665" x2="20.979" y2="2.13601" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#05F000"/>
                    <stop offset="1" stopColor="#00B51D"/>
                  </linearGradient>
                  <linearGradient id="paint1_linear_185_428" x1="4.68182" y1="6.03027" x2="16.3226" y2="14.4643" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#05F000"/>
                    <stop offset="1" stopColor="#00B51D"/>
                  </linearGradient>
                  <linearGradient id="paint2_linear_185_428" x1="1.81818" y1="16.9395" x2="5.70625" y2="17.409" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#05F000"/>
                    <stop offset="1" stopColor="#00B51D"/>
                  </linearGradient>
                  <linearGradient id="paint3_linear_185_428" x1="4.68182" y1="14.7573" x2="16.3226" y2="23.1914" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#05F000"/>
                    <stop offset="1" stopColor="#00B51D"/>
                  </linearGradient>
                </defs>
        ...
        <IntroCard title="curated content" className={'flex flex-1 justify-center h-[214px] hover:shadow-[0_0_30px_#FFE817]'}>
