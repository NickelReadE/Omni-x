  ...
  return (
    <div className='pt-[150px]'>
      <div className='flex justify-center w-full space-x-2'>
        ...
        <span className='text-[40px] leading-[48px] font-semibold text-primary-blue italic shadow-[0_4_6px_rgba(0,0,0,0.25)]'>
          omnichain
        </span>
        <span className='text-[40px] leading-[48px] font-semibold text-primary-light shadow-[0_4_6px_rgba(0,0,0,0.25)]'>
          infrastructure
        </span>
      </div>
      <div className='flex w-full mt-12 space-x-4'>
        <div className='flex flex-1 justify-center items-center flex-col'>
          <span className='text-secondary text-xl text-center'>
            A multichain world needs <span className='text-[#16FFC5]'>real omnichain solutions.</span> Your NFTs on 10+ blockchains (and
            counting) can all be viewed, traded, and shared all in one place - Omni X.
          </span>
        ...
        <div className='flex flex-1 flex-col space-y-8 pl-8'>
          <IntroCard title='NFT interoperability' className='flex justify-center'>
            <div className='flex flex-col items-center'>
              ...
              <span className='text-xl text-secondary text-center mt-6 mb-2'>10+ blockchains (and counting) powered by</span>
          ...
          <IntroCard title='deep & frictionless liquidity' className='flex justify-center'>
            <div className='flex flex-col items-center space-y-4'>
              <span className='text-xl text-secondary text-center mt-5'>trade any asset, on any chain, with any token*</span>
              <span className='text-xl text-secondary text-center'>
                a new paradigm that <span className='text-[#16FFC5]'>exponentially increases available liquidity</span> for artists and
                traders
              </span>
              <span className='text-xl italic text-secondary text-center'>*fully multichain assets $USDC, $USDT and $ETH powered by</span>
              <div>
