      ...
      <div className={"relative"}>
        {
          ...
          >
            <div
              className={"h-[40px] bg-[#303030] px-[18px] flex items-center flex-start"}
              style={
            ...
            {query !== "" && isComponentVisible && (
              <div className='p-3 overflow-auto' style={{ maxHeight: "calc(100vh - 150px)" }}>
                <div className='text-secondary' style={{ fontSize: 15, lineHeight: "19px" }}>
                  Collections
                </div>
                          ...
                          <div className={"flex flex-col"}>
                            ...
                            <div className={"flex items-center text-xs"}>
                              <span className={"bg-primary-gradient bg-clip-text text-transparent"}>
                                floor {formatDollarAmount(getMinValue([item.floor_prices.stable]))}
                              </span>
                              <span className={"bg-primary-gradient bg-clip-text text-transparent mx-2"}> | </span>
                              <span className={"bg-primary-gradient bg-clip-text text-transparent"}>
                                items {item.items_count.toLocaleString()}
                              </span>
                            </div>
                          </div>
                        </div>
                ...
                {collections.length === 0 && <div className='my-2 font-bold text-primary-light'>No results found</div>}
                <div className='text-secondary mt-4' style={{ fontSize: 15, lineHeight: "19px" }}>
                  Profiles
                </div>
                      ...
                      <Link href={`/user/${item.address}`}>
                        <div className={"flex items-center cursor-pointer"}>
                          ...
                          <div className={"flex flex-col h-[30px]"}>
                            ...
                            <div className={"text-xs truncate bg-primary-gradient bg-clip-text text-transparent"}>
                ...
                {profiles.length === 0 && <div className='my-2 font-bold text-primary-light'>No results found</div>}
              </div>
            )}
          </div>
        }
