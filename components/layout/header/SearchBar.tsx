...
export default function SearchBar() {
  ...
  return (
    <div ref={ref} className={'h-[64px] flex items-center ml-[80px]'}>
      <div className={'relative'}>
        {
          <div className={`${(query !== '' && isComponentVisible) ? 'absolute bg-[#303030]' : ''} w-[500px]`} style={(query !== '' && isComponentVisible) ? { borderRadius: '20px', top: -20 } : {}}>
            <div className={'h-[40px] bg-[#303030] w-[500px] px-[18px] flex items-center justify-between'} style={(query !== '' && isComponentVisible) ? { borderTopLeftRadius: '20px', borderTopRightRadius: '20px' } : { borderRadius: '20px' }}>
              ...
              <input
                ...
                type="text"
                placeholder='search'
                className="flex items-center text-white bg-transparent w-[500px] h-[40px] border-0 focus:outline-0 focus:shadow-none focus:ring-offset-0 focus:ring-0"
