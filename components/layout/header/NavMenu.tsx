      ...
      <ul className="flex flex-col justify-between md:flex-row md:text-sm md:font-medium h-full">
        <li className="flex w-[92px]">
          <Link href='/'>
            <a className='relative flex items-center h-full'>
              <div className={'w-[100px] h-[40px] bg-primary-gradient pb-1'}>
                <div className={`bg-primary w-full flex justify-center ${menu === 'home' ? 'h-[39px]' : 'h-[40px]'}`}>
        ...
        <li className="flex w-[92px]">
          <Link href='/collections'>
            <a className='relative flex items-center h-full'>
              <div className={'w-[100px] h-[40px] bg-primary-gradient pb-1'}>
                <div className={`bg-primary w-full flex justify-center ${menu === 'collections' ? 'h-[39px]' : 'h-[40px]'}`}>
                  <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li className="flex w-[92px]">
          <Link href='/launchpad'>
            <a className='relative flex items-center h-full'>
              <div className={'w-[100px] h-[40px] bg-primary-gradient pb-1'}>
                <div className={`bg-primary w-full flex justify-center ${menu === 'analytics' ? 'h-[39px]' : 'h-[40px]'}`}>
                  <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
