    ...
    <div className='h-full w-full flex justify-center flex-1 md:w-auto mx-auto'>
      <ul className="flex flex-col justify-between md:flex-row md:text-sm md:font-medium h-full">
        <li className="flex w-[92px]">
          <Link href='/'>
            <a className='relative flex items-center h-full'>
              <div className={`w-[100px] h-[40px] pb-2 rounded-sm ${menu === 'home' && 'bg-primary-gradient'} ${activeClass(0)}`} onMouseEnter={() => setHoveredId(0)} onMouseLeave={() => setHoveredId(undefined)}>
        ...
        <li className="flex w-[92px]">
          <Link href='/launchpad'>
            <a className='relative flex items-center h-full'>
              <div className={`w-[100px] h-[40px] pb-2 rounded-sm ${menu === 'launchpad' && 'bg-primary-gradient'} ${activeClass(1)}`} onMouseEnter={() => setHoveredId(1)} onMouseLeave={() => setHoveredId(undefined)}>
        ...
        <li className="flex w-[92px]">
          <Link href='/analytics'>
            <a className='relative flex items-center h-full'>
              <div className={`w-[100px] h-[40px] pb-2 rounded-sm ${menu === 'analytics' && 'bg-primary-gradient'} ${activeClass(2)}`} onMouseEnter={() => setHoveredId(2)} onMouseLeave={() => setHoveredId(undefined)}>
