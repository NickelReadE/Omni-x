...
export const MessageBar = () => {
  ...
  return (
    ...
    >
      <div
        className={`fixed right-0 top-[64px] bottom-[40px] w-[312px] bg-primary z-50 ${opened ? "block" : "hidden"}`}
      ...
      >
        ...
        <div
          className={`flex flex-col divide-y-[1px] divide-[#303030] border-b-[1px] border-t-[1px] border-[#303030] ${
            activeRoomId === "" ? "block" : "hidden"
          }`}
        >
          <div className={"flex items-center py-[10px] px-[13px] cursor-pointer"} onClick={() => openMessage("1")}>
            ...
            <div className={"flex flex-col w-full ml-[15px] w-[235px]"}>
              ...
              <span className={"text-secondary text-[12px] leading-[15px] truncate"}>
                hey friend, i am super interested in participating omnix
              </span>
            </div>
          </div>
          <div className={"flex items-center py-[10px] px-[13px] cursor-pointer"} onClick={() => openMessage("1")}>
        ...
        >
          <div
            className={`${activeRoomId === "" ? "hidden" : "block"} flex flex-col justify-between`}
            ...
            <div className={"pb-4 px-4"}>
              <div className={"flex flex-col space-y-3"}>
                <div className={"flex justify-start"}>
                  <div className={"bg-primary-gradient rounded-[30px] py-2 px-4"}>yo whats good my dude</div>
                </div>
                <div className={"flex justify-end"}>
                  <div className={"bg-secondary rounded-[30px] py-2 px-4"}>not much, makin art</div>
                </div>
              </div>
