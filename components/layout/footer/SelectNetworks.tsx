...
import { GAS_SUPPORTED_CHAIN_IDS, getChainLogoById, getChainOfficialNameById } from "../../../utils/constants";
      ...
      <Menu as='div' className='relative inline-block align-middle flex items-center'>
        {({ open }) => (
          <>
            ...
            >
              <div className={"absolute bottom-10 left-[-12px] w-[166px] origin-bottom-left rounded-md"}>
                          ...
                          <Menu.Item key={index} as={Fragment}>
                            <div
                              className={`py-2 px-6 flex items-center cursor-pointer ${
                                gasSupportChainIds.includes(chainId) ? "" : "bg-[#303030]"
                              }`}
