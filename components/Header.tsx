        ...
        <div className='flex flex-wrap items-start'>
          <div className='absolute'>
            <div className='flex'>
              ...
              <input autoFocus type="text" placeholder='Search' className="flex items-center bg-[#F6F8FC] bg-[url('../public/images/search.png')] bg-contain bg-no-repeat	 w-[248px] h-[40px] mt-[25px] border-0 focus:outline-0 focus:shadow-none focus:ring-offset-0 focus:ring-0 px-[42px]" onChange={e => handleChangeInput(e.target.value)}/>
            </div>
          </div>
