...
export const SwitchedNetworkProvider = ({ children }: SwitchedNetworkProviderProps) => {
  ...
  return <SwitchedNetworkContext.Provider value={{ switched, switchNetworkAsync }}>{children}</SwitchedNetworkContext.Provider>;
};
