...
type ModalDataType = IConfirmSellProps
  | IConfirmBuyProps
  | IConfirmBidProps
  | IConfirmAcceptProps
  | undefined
...
export const ModalProvider = ({
  ...
  return (
    <ModalContext.Provider value={{modal, openModal, closeModal}}>
      ...
      {modal === ModalIDs.MODAL_LISTING && !!modalData && (
        <ConfirmSell {...(modalData as IConfirmSellProps)}/>
      )}
      {modal === ModalIDs.MODAL_BUY && !!modalData && (
        <ConfirmBuy {...(modalData as IConfirmBuyProps)}/>
      )}
      {modal === ModalIDs.MODAL_BID && !!modalData && (
        <ConfirmBid {...(modalData as IConfirmBidProps)}/>
      )}
      {modal === ModalIDs.MODAL_ACCEPT && !!modalData && (
        <ConfirmAccept {...(modalData as IConfirmAcceptProps)}/>
      )}
