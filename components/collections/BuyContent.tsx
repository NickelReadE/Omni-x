    ...
    <>
      <div className='flex flex-col justify-between'>
        ...
        {buyStep === BuyStep.StepBuy ? (
          <div>
            <BuySection price={price} srcCurrency={srcCurrency} currency={currency} />
          </div>
        ) : (
          <div>
            <ApproveSection
              ...
              sectionNo={1}
              title='Approve Token'
              descriptions={["Please confirm the transaction in your wallet to process the trade."]}
            />
            <ConfirmSection
              processing={processing}
            ...
            {buyStep === BuyStep.StepDone && <CongratsSection failed={false} succeedMessage={"you successfully bought this NFT"} />}
            {buyStep === BuyStep.StepFail && <CongratsSection failed={true} failedMessage={"you failed to purchase this NFT"} />}
          </div>
        )}
      </div>
