    ...
    <>
      <div className='flex flex-col justify-between'>
        ...
        {acceptStep === AcceptStep.StepAccept || acceptStep === AcceptStep.StepCheckNetwork ? (
          <div>
            <BuySection price={price} currency={currency} />
          </div>
        ) : (
          <div>
            <ApproveSection
            ...
            {acceptStep === AcceptStep.StepDone && <CongratsSection failed={false} succeedMessage={"you successfully sold this NFT"} />}
            {acceptStep === AcceptStep.StepFail && <CongratsSection failed={true} failedMessage={"you failed to sell this NFT"} />}
          </div>
        )}
      </div>
