      ...
      <div className={`w-full mt-20 px-32 ${blur ? 'blur-sm' : ''} mb-20`}>
        <div className="px-12">
          <ul
            ...
            <li
              className={`select-none inline-block p-4 border-b-2 border-black w-40 cursor-pointer z-30 ${currentTab === 'NFTs' ? 'text-[#1E1C21] ' : ' text-[#ADB5BD] '} `}
              onClick={() => setCurrentTable('NFTs')}>
              NFTs
            </li>
            <li className={'select-none inline-block p-4  w-40 cursor-pointer  z-0  text-[#ADB5BD]'}>watchlist</li>
            <li className={'select-none inline-block p-4  w-40 cursor-pointer  z-0  text-[#ADB5BD]'}>feed</li>
            <li className={'select-none inline-block p-4  w-40 cursor-pointer  z-0  text-[#ADB5BD]'}>stats</li>
            <li className={'absolute right-0 select-none inline-block p-4  w-40 cursor-pointer   text-[#6C757D]'} onClick={() => setOpenModal(true) }>settings</li>
          </ul>
