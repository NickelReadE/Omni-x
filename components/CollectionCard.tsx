          ...
          <div className='text-[14px] flex flex-col justify-center' style={{justifyContent: 'space-between'}}>
            <div className='text-[14px] flex flex-col justify-center' style={{justifyContent: 'space-between'}}>
              ...
              <div className='flex flex-row space-x-2 justify-center' >
                <span className='font-medium text-[12px] mr-[px]'>{props.card?visualizeNumber(props.card.floorPrice.usd):<Image src={Loading} alt='Loading...' width='20px' height='20px'/>}</span>
