    ...
    <>
      <div className='w-full flex flex-row min-h-[750px]'>
          ...
          <ul className='mt-[1rem] pt-10 pl-3'>
            <li className={`${selectedTab == 0 ? "pr-1" : ""} leading-[60px] bg-primary-gradient`}>
              <button
                ...
                className='flex justify-start items-center text-lg pl-0 font-medium w-full border-r-1 border-r-transparent outline-none bg-primary'
              >
                <div className={""}>
                  <UserSVG className='inline stroke-primary-light' />
                </div>
            ...
            <li className={`${selectedTab == 1 ? "pr-1" : ""} leading-[60px] bg-primary-gradient mt-10`}>
              <button
                ...
                className='flex justify-start items-center text-lg pl-0 font-medium w-full border-r-1 border-r-transparent outline-none bg-primary'
              >
                <div className={"stroke-primary-light"}>
                  <AlertSVG className='inline stroke-primary-light' />
                </div>
            ...
            <li className={`${selectedTab == 2 ? "pr-1" : ""} leading-[60px] bg-primary-gradient mt-10`}>
              ...
              >
                <div className={""}>
                  <PaymentSVG className='inline stroke-primary-light' />
                </div>
        ...
        <div className='relative basis-5/6 p-12 bg-primary'>
          {selectedTab == 0 && (
            <form ref={updateProfileFormRef} onSubmit={updateProfile} className={"h-full flex flex-col justify-between"}>
              <div className={"flex flex-col"}>
                <input id='image_banner' accept='image/*' type='file' onChange={onChangeBanner} className='hidden' />
                ...
                <div className='flex mt-5 w-full '>
                  ...
                  <input id='image_avatar' accept='image/*' type='file' onChange={onChangeAvatar} className='hidden' name='avatar' />
