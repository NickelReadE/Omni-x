        ...
        {hover ? (
          <div className={"flex items-center justify-between px-3 space-x-5"}>
            ...
            <PrimaryButton
              ...
              onClick={() => router.push(`/collections/${collection.col_url}/edit`)}
            />
          </div>
        ) : (
          <div className='flex justify-between h-[48px]'>
            <div className={"flex flex-col items-center justify-between"}>
              ...
              <TextBodyemphasis className={"text-primary-light"}>{collection.items_count}</TextBodyemphasis>
            </div>
            <div className={"flex flex-col items-center justify-between"}>
              <TextBody className={"text-[#969696]"}>Owners</TextBody>
              <TextBodyemphasis className={"text-primary-light"}>{collection.owners_count}</TextBodyemphasis>
            </div>
            <div className={"flex flex-col items-center justify-between"}>
              <TextBody className={"text-[#969696]"}>Floor</TextBody>
              <TextBodyemphasis className={"text-primary-light"}>{formatDollarAmount(floor_price)}</TextBodyemphasis>
            </div>
            <div className={"flex flex-col items-center justify-between"}>
              <TextBody className={"text-[#969696]"}>Revenue</TextBody>
              <TextBodyemphasis className={"text-primary-light"}>{collection.revenue}</TextBodyemphasis>
            </div>
          </div>
        )}
      </div>
