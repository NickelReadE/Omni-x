  ...
  return (
    <div className='flex items-center justify-between space-x-4 text-primary-light mt-4'>
      ...
      <div className={"flex flex-1 items-center"}>
        {activity.srcChainId &&
          (activity.activity === USER_ACTIVITY_TYPE.Send ||
            activity.activity === USER_ACTIVITY_TYPE.Sell ||
            activity.activity === USER_ACTIVITY_TYPE.Buy) && (
            <img
              alt={"networkIcon"}
      ...
      <div className={"flex flex-1 justify-end text-md"}>
        ...
        <div className='col-span-4 inline-flex flex flex-col rounded-md shadow-sm' role='group'>
          ...
          <div className='w-full'>
            {activities.map((activity, index) => {
              return <ActivitySend key={index} activity={activity} />;
            })}
          </div>
        </div>
      </div>
